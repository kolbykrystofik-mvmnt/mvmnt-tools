...
const TOOLS = [
  ...
  },
  {
    path: "/life-score",
    emoji: "📈",
    label: "Life Score Audit",
    tagline: "Rate 7 pillars of your life and find your focus",
    description: "Slide through 7 areas — sleep, nutrition, movement, stress, social connection, financials, and purpose — and get a scored breakdown with a radar chart and action tips for your lowest area.",
    color: "#2A5A7A",
    tags: ["Sleep", "Nutrition", "Movement", "Stress", "Purpose"],
  },
  {
    path: "/mindset",
    emoji: "🧠",
    label: "Mindset Pattern Identifier",
    tagline: "Discover how your mind works against you",
    description: "12 statements rated on a 1–5 scale reveal your dominant mindset pattern across 6 types — Perfectionist, Avoider, Sprinter, Comparer, Steady Builder, or Seeker — with targeted reframes for your type.",
    color: "#4A3A6A",
    tags: ["Mindset", "Self-Awareness", "Behavior Change", "Reframes"],
  },
  // ── ADD NEW TOOLS HERE ──
  // {
  //   path: "/new-tool",
    ...
    <div style={{ minHeight: "100vh", background: C.bg, fontFamily: "'Oswald', sans-serif" }}>
      ...
      <div style={{ background: "#1A1A1A", padding: "48px 28px 44px" }}>
        <div style={{ maxWidth: 640, margin: "0 auto" }}>
          ...
          <div style={{ ...os, fontSize: 15, color: "#9A9890", lineHeight: 1.7, maxWidth: 500 }}>
            Free tools to help you dial in your nutrition, training, mindset, and life. No fluff. Just results.
          </div>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "36px 20px 60px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          {TOOLS.map((tool) => (
            <div key={tool.path} className="tool-card" style={{ background: C.bgCard, border: `1px solid ${C.border}`, borderRadius: 14, overflow: "hidden", boxShadow: C.shadowMd }}>
              ...
              <div style={{ padding: "22px 24px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 12 }}>
                  ...
                  <div>
                    ...
                    <div style={{ ...os, fontSize: 12, color: C.accent, marginTop: 3, fontWeight: 500 }}>{tool.tagline}</div>
                  </div>
                </div>
                ...
                <button className="launch-btn" onClick={() => navigate(tool.path)} style={{ ...os, background: C.accent, color: "#fff", border: "none", borderRadius: 8, padding: "12px 24px", fontWeight: "bold", fontSize: 12, cursor: "pointer", letterSpacing: "0.08em", textTransform: "uppercase", boxShadow: `0 2px 10px ${C.accent}40` }}>
                  Open Tool →
                </button>
              </div>
            </div>
        ...
        <div style={{ marginTop: 16, background: C.bgAlt, border: `1.5px dashed ${C.border}`, borderRadius: 14, padding: "28px 24px", textAlign: "center" }}>
          ...
          <div style={{ ...os, fontSize: 12, color: C.muted }}>Habit Stack Builder · Recovery Protocol · Health Identity Script</div>
        </div>
