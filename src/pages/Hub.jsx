    ...
    <div style={{ minHeight: "100vh", background: C.bg, fontFamily: "'Oswald', sans-serif" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "36px 20px 60px" }}>
            ...
            >
              ...
              <div style={{ padding: "22px 24px" }}>
                <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 16, marginBottom: 12 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                    ...
                    <div>
                      ...
                      <div style={{ ...os, fontSize: 12, color: tool.color, marginTop: 3, fontWeight: 500 }}>{tool.tagline}</div>
                    </div>
                  </div>
                </div>
                ...
                <button
                  ...
                  style={{ ...os, background: tool.color, color: "#fff", border: "none", borderRadius: 8, padding: "12px 24px", fontWeight: "bold", fontSize: 12, cursor: "pointer", letterSpacing: "0.08em", textTransform: "uppercase", boxShadow: `0 2px 10px ${tool.color}40` }}
                >
                  Open Tool →
                </button>
              </div>
        ...
        <div style={{ marginTop: 16, background: C.bgAlt, border: `1.5px dashed ${C.border}`, borderRadius: 14, padding: "28px 24px", textAlign: "center" }}>
          ...
          <div style={{ ...os, fontSize: 12, color: C.tan }}>Foundations Assessment · 1RM Calculator · Recovery Tracker</div>
        </div>
